...
return(
        ...
        <View 
        style={{height:320,width:300,backgroundColor:"white",position:"absolute",marginLeft:30,marginTop:120}}>
          ...
          <TouchableOpacity style={Style.button1} onPress={() => navigation.navigate('')}>
